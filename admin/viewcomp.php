 ...
 include('dbfunctions.php');
	...
	if(isset($_SESSION['email']) && isset($_SESSION['is_admin']))
	{
		if($_SESSION['is_admin']){
			...
			$title = "Department";
			$sql1 = "SELECT * FROM `department_user` WHERE email = '".$_SESSION['email']."' OR phone_no = '".$_SESSION['email']."'";
			...
			$sql = "SELECT * FROM `complaint` where deptname = '".$data['dept_id']."' AND areaname = '".$data['area_id']."'";
   		    $result=mysqli_query($connection->myconn,$sql);
...
<!--										<a href="approvecomp.php?id=<?php echo $row['compid'] ?>">Approve</a> &nbsp; | &nbsp;-->
									...
									<td>
      						<a href="approvecomp.php?id=<?php echo $row['compid'] ?>">Approve</a> &nbsp; | &nbsp;
							  <a href="deletecomp.php?id=<?php echo $row['compid'] ?>" onclick='return checkdelete()'>Delete</a>
									</td>
									<script>
