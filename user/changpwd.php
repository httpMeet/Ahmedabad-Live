                        ...
                        <div class="col-md-9 col-md-pull-3">
                            ...
                            <div class="navigation-banner-swiper">
                                <div class="swiper-container" data-autoplay="5000" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
									...
									<form method="post" action="changpwdcode.php">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>Old password <span>*</span></label>
                                        <input class="simple-field" type="text" placeholder="Your old password (required)" required value="" name="opwd"/>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="col-sm-12">
                                        <label>New password</label>
                                        <input class="simple-field" name="npwd" type="text" placeholder="Your new password" value=""  />
                                        <div class="clear" ></div>
                                    </div>
									<div class="col-sm-12">
                                        <label>renter new passwordpassword</label>
                                        <input class="simple-field" name="cpwd" type="text" placeholder="confirm password" value=""  />
                                        <div class="clear" ></div>
                                    </div>
                                    <div class="col-sm-12">
                                       
                                        <div class="button style-10">Change password<input  name="submit" type="submit" value="" /></div>
                                    </div>
                                </div>
                            </form>
                                    <div class="clear"></div>
